    ...
    >
      {data.map((c, i) => (
        <article
          ...
          className="group relative flex flex-col w-[280px] md:w-[300px] rounded-2xl overflow-hidden border-2 border-transparent transition-colors duration-300 cursor-pointer"
          style={
            {
