      ...
      <section className="relative bg-[url('https://images.unsplash.com/photo-1521587760476-6c12a4b040da?q=80&w=2000&auto=format&fit=crop')] bg-cover bg-center">
        <div className="bg-black/40">
          <div className="container mx-auto px-6 py-20 text-white">
            ...
            <p className="mt-2 text-white/90">Commissions, inquiries, and collaborations welcome</p>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 py-12 grid md:grid-cols-3 gap-10">
        <form className="md:col-span-2 bg-white rounded-2xl shadow p-6 grid gap-4">
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <input type="email" className="border rounded-lg px-3 py-2" placeholder="Email" required />
          </div>
          ...
          <textarea className="border rounded-lg px-3 py-2 h-40" placeholder="Message" required />
          <button className="rounded-full bg-primary text-white px-6 py-3 font-medium">Send Message</button>
        </form>
        <aside className="bg-secondary/60 rounded-2xl p-6">
          <h3 className="text-xl font-semibold">Contact Information</h3>
          <ul className="mt-3 space-y-2 text-foreground/80">
            <li>Email: <a className="underline" href="mailto:dherma6969@gmail.com">dherma6969@gmail.com</a></li>
